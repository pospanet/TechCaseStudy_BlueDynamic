# Workflow 4 — Upgrade .NET Frameworku
...
| Review business zadání | Claude Opus 4.6 | `review-change` nebo bez skillu | nový nezávislý |
...
Conservative .NET Framework modernization
...
- zachování buildability a maintainability,
- snížení rizika nepodporované platformy,
- zlepšení dependency compatibility a security posture,
- zachování chování aplikace,
- explicitní výjimky pro projekty, které nelze upgradovat.
...
- každý in-scope projekt cílí schválený framework nebo má zdokumentovanou výjimku,
- solution a podporované projekty se sestaví v definovaném prostředí,
- testy projdou nebo jsou zdokumentovány pre-existing failures,
- package a assembly compatibility je ověřena,
- binding redirects a runtime configuration jsou validní,
- kritické flow projdou smoke testem.

Avoid implementation design unless it is a necessary business constraint.

Save as:
`docs/work-items/dotnet-framework-upgrade-business-requirement.md`
...
`docs/work-items/dotnet-framework-upgrade-business-requirement.review.md`
...
Analysis focus:
- project types a target frameworks,
- NuGet a assembly compatibility,
- binding redirects,
- application configuration,
- Azure SDK a UWP constraints,
- build tooling,
- runtime behavior changes a deployment prerequisites.

Every mandatory acceptance criterion must map to implementation steps, validation steps and expected evidence.

Save as:
`docs/work-items/dotnet-framework-upgrade-implementation-plan.md`
...
Save the complete review as:
`docs/work-items/dotnet-framework-upgrade-implementation-plan.review.md`
...
Save as:
`docs/work-items/dotnet-framework-upgrade-tasks.md`
...
Save the complete review as:
`docs/work-items/dotnet-framework-upgrade-TASK-ID-code-review.md`

For a reviewed task range, use:
`docs/work-items/dotnet-framework-upgrade-TASK-ID-to-TASK-ID-code-review.md`
...
- single task: `docs/work-items/dotnet-framework-upgrade-TASK-ID-code-review.md`
- task range: `docs/work-items/dotnet-framework-upgrade-TASK-ID-to-TASK-ID-code-review.md`
...
7. Update the affected task entries in `docs/work-items/dotnet-framework-upgrade-tasks.md` with final status, validation evidence and any approved residual risk.
