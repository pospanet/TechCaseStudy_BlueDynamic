# Workflow 3 — Výkonnostní optimalizace
...
- snížení uživatelské latence nebo doby zpracování,
- snížení počtu externích volání a provozních nákladů,
- zvýšení throughputu a škálovatelnosti,
- prevenci vyčerpání zdrojů,
- povinné měření před a po optimalizaci.
...
- existuje reprodukovatelný baseline,
- cílová metrika a threshold jsou explicitní,
- optimalizovaná cesta splní threshold nebo dohodnuté relativní zlepšení,
- korektnost zůstane zachována,
- resource use a external-call count nepřekročí definované limity,
- performance test nebo instrumentation zůstane v repu, kde je to praktické.

Avoid implementation design unless it is a necessary business constraint.

Save as:
`docs/work-items/performance-optimization-business-requirement.md`
...
`docs/work-items/performance-optimization-business-requirement.review.md`
...
Analysis focus:
- hot paths,
- síťové a Azure round trips,
- databázový přístup,
- image a payload handling,
- serializaci,
- synchronní blokování,
- paralelizaci,
- retry behavior,
- batching, caching, resource reuse a backpressure.

Every mandatory acceptance criterion must map to implementation steps, validation steps and expected evidence.

Save as:
`docs/work-items/performance-optimization-implementation-plan.md`
...
Save the complete review as:
`docs/work-items/performance-optimization-implementation-plan.review.md`
...
Save as:
`docs/work-items/performance-optimization-tasks.md`
...
Save the complete review as:
`docs/work-items/performance-optimization-TASK-ID-code-review.md`

For a reviewed task range, use:
`docs/work-items/performance-optimization-TASK-ID-to-TASK-ID-code-review.md`
...
- single task: `docs/work-items/performance-optimization-TASK-ID-code-review.md`
- task range: `docs/work-items/performance-optimization-TASK-ID-to-TASK-ID-code-review.md`
...
7. Update the affected task entries in `docs/work-items/performance-optimization-tasks.md` with final status, validation evidence and any approved residual risk.
