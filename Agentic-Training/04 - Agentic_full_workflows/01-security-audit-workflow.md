...
Autentizační mezery, authorization bypass, credentials v klientovi, device impersonation, cross-tenant přístup, biometrická retence a nepodporované závislosti.
